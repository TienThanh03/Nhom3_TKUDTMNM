...
class Add:
    ...
    def compute_sum(self):
        ...
        try:
            ...
            Label(self.frame_add_output, text="Ma trận của bạn").grid(row=1, column=self.cols_get * 2 + 10)
            Label(self.frame_add_output, text="Không hợp lệ!").grid(row=2, column=self.cols_get * 2 + 10)
