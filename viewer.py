...
class ImageViewer(Frame):
    ...
    def __init__(self, master=None):
        Frame.__init__(self, master=master, bg="#ababab", width=900, height=600)
        ...
        self.canvas = Canvas(self, bg="#ababab", width=900, height=600)
    ...
    def draw(self, event):
        self.draw_ids.append(self.canvas.create_line(self.x, self.y, event.x, event.y, width=6,
